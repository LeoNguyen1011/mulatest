...
class PayBillConfirmPage extends StatelessWidget {
  const PayBillConfirmPage({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _fee(fee: "00.00", ewaDrawFee: "30.00"),
            const Divider(
              thickness: 0.3,
            ),
  ...
  Padding _fee({required String fee, required String ewaDrawFee}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 16),
      child: Column(
        children: [
